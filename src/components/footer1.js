              ...
              <div className="footer1-form">
                ...
                <button className="thq-button-outline footer1-button">
                  <span className="thq-body-small">
                    {props.action1 ?? (
                      <Fragment>
                        <span className="footer1-text25">Subscribe</span>
                      </Fragment>
                    )}
                  </span>
                </button>
          ...
          <div className="footer1-links">
            <div className="footer1-column1">
              <strong className="thq-body-large footer1-column1-title">
                {props.column1Title ?? (
                  <Fragment>
                    <span className="footer1-text20">Column One</span>
                  </Fragment>
                )}
              </strong>
              <div className="footer1-footer-links1">
                ...
                >
                  {props.link1 ?? (
                    <Fragment>
                      <span className="footer1-text16">Link 1</span>
                    </Fragment>
                  )}
                </a>
                <a
                ...
                >
                  {props.link2 ?? (
                    <Fragment>
                      <span className="footer1-text23">Link 2</span>
                    </Fragment>
                  )}
                </a>
                <a
                ...
                >
                  {props.link3 ?? (
                    <Fragment>
                      <span className="footer1-text14">Link 3</span>
                    </Fragment>
                  )}
                </a>
                <a
                ...
                >
                  {props.link4 ?? (
                    <Fragment>
                      <span className="footer1-text26">Link 4</span>
                    </Fragment>
                  )}
                </a>
                <a
                ...
                >
                  {props.link5 ?? (
                    <Fragment>
                      <span className="footer1-text11">Link 5</span>
                    </Fragment>
                  )}
                </a>
              </div>
            ...
            <div className="footer1-column2">
              <strong className="thq-body-large footer1-column2-title">
                {props.column2Title ?? (
                  <Fragment>
                    <span className="footer1-text24">Column Two</span>
                  </Fragment>
                )}
              </strong>
              <div className="footer1-footer-links2">
                ...
                >
                  {props.link7 ?? (
                    <Fragment>
                      <span className="footer1-text17">Link 7</span>
                    </Fragment>
                  )}
                </a>
                <a
                ...
                >
                  {props.link8 ?? (
                    <Fragment>
                      <span className="footer1-text22">Link 8</span>
                    </Fragment>
                  )}
                </a>
                <a
                ...
                >
                  {props.link9 ?? (
                    <Fragment>
                      <span className="footer1-text27">Link 9</span>
                    </Fragment>
                  )}
                </a>
                <a
                ...
                >
                  {props.link10 ?? (
                    <Fragment>
                      <span className="footer1-text12">Link 10</span>
                    </Fragment>
                  )}
                </a>
              </div>
            ...
            <div className="footer1-column3">
              <strong className="thq-body-large footer1-social-link1-title">
                {props.socialLinkTitleCategory ?? (
                  <Fragment>
                    <span className="footer1-text21">Follow Us</span>
                  </Fragment>
                )}
              </strong>
        ...
        <div className="footer1-credits">
          ...
          <div className="footer1-row">
            <span className="thq-body-small">
              {props.content3 ?? (
                <Fragment>
                  <span className="footer1-text13">© 2024 TeleportHQ</span>
                </Fragment>
              )}
            </span>
            <div className="footer1-footer-links3">
              <span className="thq-body-small">
                {props.privacyLink ?? (
                  <Fragment>
                    <span className="footer1-text18">Privacy Policy</span>
                  </Fragment>
                )}
              </span>
              <span className="thq-body-small">
                {props.termsLink ?? (
                  <Fragment>
                    <span className="footer1-text28">Terms of Service</span>
                  </Fragment>
                )}
              </span>
              <span className="thq-body-small">
                {props.cookiesLink ?? (
                  <Fragment>
                    <span className="footer1-text10">Cookies Settings</span>
                  </Fragment>
                )}
              </span>
            </div>

            ...
            <div className="footer2-container1">
              <div className="footer2-column1">
                <strong className="thq-body-large">
                  {props.column1Title ?? (
                    <Fragment>
                      <span className="footer2-text20">Column One</span>
                    </Fragment>
                  )}
                </strong>
                <div className="footer2-footer-links1">
                  ...
                  >
                    {props.link1 ?? (
                      <Fragment>
                        <span className="footer2-text24">Link 1</span>
                      </Fragment>
                    )}
                  </a>
                  <a
                  ...
                  >
                    {props.link2 ?? (
                      <Fragment>
                        <span className="footer2-text13">Link 2</span>
                      </Fragment>
                    )}
                  </a>
                  <a
                  ...
                  >
                    {props.link3 ?? (
                      <Fragment>
                        <span className="footer2-text16">Link 3</span>
                      </Fragment>
                    )}
                  </a>
                  <a
                  ...
                  >
                    {props.link4 ?? (
                      <Fragment>
                        <span className="footer2-text10">Link 4</span>
                      </Fragment>
                    )}
                  </a>
                  <a
                  ...
                  >
                    {props.link5 ?? (
                      <Fragment>
                        <span className="footer2-text19">Link 5</span>
                      </Fragment>
                    )}
                  </a>
                </div>
              ...
              <div className="footer2-column2">
                <strong className="thq-body-large">
                  {props.column2Title ?? (
                    <Fragment>
                      <span className="footer2-text11">Column Two</span>
                    </Fragment>
                  )}
                </strong>
                <div className="footer2-footer-links2">
                  ...
                  >
                    {props.link6 ?? (
                      <Fragment>
                        <span className="footer2-text25">Link 6</span>
                      </Fragment>
                    )}
                  </a>
                  <a
                  ...
                  >
                    {props.link7 ?? (
                      <Fragment>
                        <span className="footer2-text26">Link 7</span>
                      </Fragment>
                    )}
                  </a>
                  <a
                  ...
                  >
                    {props.link8 ?? (
                      <Fragment>
                        <span className="footer2-text14">Link 8</span>
                      </Fragment>
                    )}
                  </a>
                  <a
                  ...
                  >
                    {props.link9 ?? (
                      <Fragment>
                        <span className="footer2-text27">Link 9</span>
                      </Fragment>
                    )}
                  </a>
                  <a
                  ...
                  >
                    {props.link10 ?? (
                      <Fragment>
                        <span className="footer2-text15">Link 10</span>
                      </Fragment>
                    )}
                  </a>
                </div>
              ...
              <div className="footer2-form">
                ...
                <button className="thq-button-outline footer2-button">
                  <span className="thq-body-small">
                    {props.action1 ?? (
                      <Fragment>
                        <span className="footer2-text21">Subscribe</span>
                      </Fragment>
                    )}
                  </span>
                </button>
            ...
            <div className="footer2-credits2">
              ...
              <div className="footer2-footer-links3">
                <span className="thq-body-small">
                  {props.privacyLink ?? (
                    <Fragment>
                      <span className="footer2-text23">Privacy Policy</span>
                    </Fragment>
                  )}
                </span>
                <span className="thq-body-small">
                  {props.termsLink ?? (
                    <Fragment>
                      <span className="footer2-text18">Terms of Service</span>
                    </Fragment>
                  )}
                </span>
                <span className="thq-body-small">
                  {props.cookiesLink ?? (
                    <Fragment>
                      <span className="footer2-text17">Cookies Settings</span>
                    </Fragment>
                  )}
                </span>
              </div>

        ...
        <div className="team1-section-title">
          ...
          <div className="team1-content10">
            <h2 className="thq-heading-2 team1-text11">
              {props.heading1 ?? (
                <Fragment>
                  <span className="team1-text61">Meet Our Creative Team</span>
                </Fragment>
              )}
            </h2>
                  ...
                  <div className="team1-content13">
                    <div className="team1-title1">
                      ...
                      <span className="team1-text14 thq-body-small">
                        {props.member1Job ?? (
                          <Fragment>
                            <span className="team1-text41">Lead Designer</span>
                          </Fragment>
                        )}
                      </span>
                    </div>
                      ...
                      {props.member1Content ?? (
                        <Fragment>
                          <span className="team1-text48">
                            John is our visionary lead designer with a passion
                            for creating unique and impactful designs that
                            resonate with our clients&apos; brands.
                          </span>
                        </Fragment>
                      )}
                    </span>
                  ...
                  <div className="team1-content14">
                    <div className="team1-title2">
                      <span className="team1-text16 thq-body-small">
                        {props.member2 ?? (
                          <Fragment>
                            <span className="team1-text40">Jane Smith</span>
                          </Fragment>
                        )}
                      </span>
                      ...
                      {props.member2Content ?? (
                        <Fragment>
                          <span className="team1-text60">
                            Jane brings a fresh perspective to every project she
                            works on, combining creativity with attention to
                            detail to deliver stunning visuals.
                          </span>
                        </Fragment>
                      )}
                    </span>
                  ...
                  <div className="team1-content15">
                    <div className="team1-title3">
                      <span className="team1-text19 thq-body-small">
                        {props.member3 ?? (
                          <Fragment>
                            <span className="team1-text65">Alex Johnson</span>
                          </Fragment>
                        )}
                      </span>
                      <span className="team1-text20 thq-body-small">
                        {props.member3Job ?? (
                          <Fragment>
                            <span className="team1-text44">Illustrator</span>
                          </Fragment>
                        )}
                      </span>
                    </div>
                      ...
                      {props.member3Content ?? (
                        <Fragment>
                          <span className="team1-text69">
                            Alex&apos;s illustrations breathe life into our
                            designs, adding a touch of whimsy and charm that
                            sets our work apart.
                          </span>
                        </Fragment>
                      )}
                  ...
                  <div className="team1-content16">
                    <div className="team1-title4">
                      <span className="team1-text22 thq-body-small">
                        {props.member4 ?? (
                          <Fragment>
                            <span className="team1-text47">Emily Brown</span>
                          </Fragment>
                        )}
                      </span>
                      ...
                      {props.member4Content ?? (
                        <Fragment>
                          <span className="team1-text62">
                            Emily&apos;s expertise in brand strategy ensures
                            that our designs not only look great but also
                  ...
                  <div className="team1-content17">
                    <div className="team1-title5">
                      ...
                      <span className="team1-text26 thq-body-small">
                        {props.member5Job ?? (
                          <Fragment>
                            <span className="team1-text45">Job title</span>
                          </Fragment>
                        )}
                      </span>
                    </div>
                  ...
                  <div className="team1-content19">
                    <div className="team1-title7">
                      <span className="team1-text31 thq-body-small">
                        {props.member7 ?? (
                          <Fragment>
                            <span className="team1-text53">Full name</span>
                          </Fragment>
                        )}
                      </span>
...
Team1.defaultProps = {
  ...
  member3Alt: 'Image of Alex Johnson, Illustrator',
  member5Src:
    'https://images.unsplash.com/photo-1579783483458-83d02161294e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc1MzA5NjMxOXw&ixlib=rb-4.1.0&q=80&w=1080',
  member5Content: undefined,
  member2Src:
    'https://images.unsplash.com/photo-1636041282858-351171ff944c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc1MzA5NjMyMHw&ixlib=rb-4.1.0&q=80&w=1080',
  member8Job: undefined,
  member3Job: undefined,
  member5Job: undefined,
  member5Alt: 'Member Alt',
  member1Alt: 'Image of John Doe, Lead Designer',
  ...
  member1Src:
    'https://images.unsplash.com/photo-1497316730643-415fac54a2af?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc1MzA5NjMyMXw&ixlib=rb-4.1.0&q=80&w=1080',
  member2Content: undefined,
  heading1: undefined,
  member7Src:
    'https://images.unsplash.com/photo-1505837070343-f0f1722298ea?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc1MzA5NjMyMHw&ixlib=rb-4.1.0&q=80&w=1080',
  member4Content: undefined,
  member4Src:
    'https://images.unsplash.com/photo-1604883781269-d121d9ad20f6?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc1MzA5NjMyMHw&ixlib=rb-4.1.0&q=80&w=1080',
  member8Alt: 'Member Alt',
  member6Job: undefined,
  member6Src:
    'https://images.unsplash.com/photo-1492681290082-e932832941e6?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc1MzA5NjMyMHw&ixlib=rb-4.1.0&q=80&w=1080',
  actionContent: undefined,
  member3: undefined,
  member4Alt: 'Image of Emily Brown, Brand Strategist',
  member8Src:
    'https://images.unsplash.com/photo-1636041282803-3b626a7c3166?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc1MzA5NjMxOXw&ixlib=rb-4.1.0&q=80&w=1080',
  member2Alt: 'Image of Jane Smith, Graphic Designer',
  member7Alt: 'Member Alt',
  member3Src:
    'https://images.unsplash.com/photo-1529626455594-4ff0802cfb7e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc1MzA5NjMyMHw&ixlib=rb-4.1.0&q=80&w=1080',
  content1: undefined,
  heading2: undefined,

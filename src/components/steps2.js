          ...
          <div className="steps2-container3">
                ...
                {props.step1Description ?? (
                  <Fragment>
                    <span className="steps2-text30">
                      Contact me via Instagram to discuss your design
                      requirements and vision for your project.
                    </span>
                  </Fragment>
                )}
              </span>
                ...
                {props.step2Description ?? (
                  <Fragment>
                    <span className="steps2-text28">
                      I will create unique design concepts tailored to your
                      brand or project for you to review.
                    </span>
                  </Fragment>
                )}
              </span>
                ...
                {props.step3Description ?? (
                  <Fragment>
                    <span className="steps2-text25">
                      Share your feedback on the initial designs, and I will
                      make revisions until you are completely satisfied.
                    </span>
                  </Fragment>
                )}
              </span>
            ...
            <div className="steps2-container7 thq-card">
              <h2 className="thq-heading-2">
                {props.step4Title ?? (
                  <Fragment>
                    <span className="steps2-text32">Finalize and Deliver</span>
                  </Fragment>
                )}
              </h2>
                ...
                {props.step4Description ?? (
                  <Fragment>
                    <span className="steps2-text29">
                      Once the design is approved, I will finalize the files and
                      deliver them to you in the necessary formats.
                    </span>
                  </Fragment>
                )}
              </span>

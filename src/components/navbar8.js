        ...
        <div data-thq="thq-navbar-nav" className="navbar8-desktop-menu">
          <nav className="navbar8-links1">
            ...
            >
              {props.link2 ?? (
                <Fragment>
                  <span className="navbar8-text16">Contact</span>
                </Fragment>
              )}
            </Link>
            <Link
            ...
            >
              {props.link3 ?? (
                <Fragment>
                  <span className="navbar8-text14">Designs</span>
                </Fragment>
              )}
            </Link>
            <Link to="/about" className="navbar8-navlink2">
              <div
                onClick={() => setLink5DropdownVisible(!link5DropdownVisible)}
                className="navbar8-link4-dropdown-trigger"
              >
                <span className="navbar8-link51 thq-body-small thq-link">
                  {props.link4 ?? (
                    <Fragment>
                      ...
                      <div className="navbar8-menu-item2">
                        ...
                        <div className="navbar8-content2">
                          <span className="navbar8-page21 thq-body-large">
                            {props.page2 ?? (
                              <Fragment>
                                <span className="navbar8-text23">Page Two</span>
                              </Fragment>
                            )}
                          </span>
                          <span className="thq-body-small">
                ...
                <div className="navbar8-menu-item7">
                  ...
                  <div className="navbar8-content7">
                    <span className="navbar8-page32 thq-body-large">
                      {props.page3 ?? (
                        <Fragment>
                          <span className="navbar8-text24">Page Three</span>
                        </Fragment>
                      )}
                    </span>
                    <span className="thq-body-small">
...
Navbar8.defaultProps = {
  ...
  page3ImageAlt: 'image',
  page1ImageSrc:
    'https://images.unsplash.com/photo-1643886418577-c63d4fab8537?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc1MzAwODk3MHw&ixlib=rb-4.1.0&q=80&w=200',
  link3: undefined,
  ...
  link4: undefined,
  page4ImageSrc:
    'https://images.unsplash.com/photo-1470790376778-a9fbc86d70e2?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc1MzAwODk3MHw&ixlib=rb-4.1.0&q=80&w=200',
  page4: undefined,
  page2ImageAlt: 'image',
  link3Url: 'https://www.teleporthq.io',
  linkUrlPage3: 'https://www.teleporthq.io',
  page2ImageSrc:
    'https://images.unsplash.com/photo-1684236685989-baafbf7bef95?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc1MzAwODk3MHw&ixlib=rb-4.1.0&q=80&w=200',
  rootClassName: '',
  page1ImageAlt: 'image',
  ...
  action1: undefined,
  page3ImageSrc:
    'https://images.unsplash.com/photo-1668069109703-bab425dfa031?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc1MzAwODk3MHw&ixlib=rb-4.1.0&q=80&w=200',
  logoAlt: 'logo',
  imageAlt: 'image',
  page4ImageAlt: 'image',
  imageSrc: '/bild_2025-07-20_220134119-200h.png',
}
